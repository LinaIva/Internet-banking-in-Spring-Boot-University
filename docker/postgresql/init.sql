...
GRANT ALL PRIVILEGES ON DATABASE cvicenie_docker to user;
...
CREATE SCHEMA cvicenie_docker AUTHORIZATION user;
GRANT ALL PRIVILEGES ON SCHEMA cvicenie_docker TO user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA cvicenie_docker TO user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA cvicenie_docker TO user;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA cvicenie_docker TO user;
